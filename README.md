...
- 26 лекционных тем;
- 117 экранов в каждой теме: титульный лист, тема семестра, литература с QR-кодами, учебные вопросы, блоки для конспекта, четыре самопроверки после каждого вопроса, практика и вопросы от аудитории;
