...
- 26 лекционных тем;
- 85 экранов в каждой теме: титульный лист, тема семестра, литература, QR материалов, учебный блок, задания, тесты и вопросы от аудитории;
- реалистичный сквозной кейс WMS;
- настраиваемые ФИО, должность и кафедра преподавателя с сохранением в браузере и переносом в PDF;
